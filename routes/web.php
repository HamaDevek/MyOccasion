...
Route::get('/meHeWh43AnvMFLYIEd6p5YGbnvdHIWPVZkXJpRDO2Yoxzc51dZe9MI8Z3bvAV8jIj6iyNJcExq1UqVMu/71OPL1bbXhOBGts3MPG0iEqE2PskhoSefwROlS', 'Settings\AuthController@index')->name('login.index');
Route::post('/meHeWh43AnvMFLYIEd6p5YGbnvdHIWPVZkXJpRDO2Yoxzc51dZe9MI8Z3bvAV8jIj6iyNJcExq1UqVMu/71OPL1bbXhOBGts3MPG0iEqE2PskhoSefwROlS', 'Settings\AuthController@check')->name('login.check');
Route::get('/meHeWh43AnvMFLYIEd6p5YGbnvdHIWPVZkXJpRDO2Yoxzc51dZe9MI8Z3bvAV8jIj6iyNJcExq1UqVMu/71OPL1bbXhOBGts3MPG0iEqE2PskhoSefwROlS/logout', 'Settings\AuthController@logout')->name('login.logoutadmin');
Route::group([
    'middleware' => ['login'],
    'as' => 'dashboard.'
],function () {
